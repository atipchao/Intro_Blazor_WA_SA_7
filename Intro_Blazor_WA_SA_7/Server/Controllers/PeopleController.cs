...
namespace Intro_Blazor_WA_SA_7.Server.Controllers
{
    ...
    public class PeopleController : ControllerBase 
    {
        ...
        {
            return await _dbContext.People.Where(s => s.Id == id).ToListAsync();
        }
        ...
        [HttpPut] async Task<ActionResult> Put(Person person)
        {
        ...
        [HttpDelete("{id}")] async Task<ActionResult> Delete(int id)
        {
